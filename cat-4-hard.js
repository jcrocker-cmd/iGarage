const brands = [
  {
    iconName: "alternator.png",
    brandName: "Alternator",
  },
  {
    iconName: "brakes.png",
    brandName: "Brakes",
  ...
  {
    iconName: "cc.png",
    brandName: "Catalyctic Converter",
  },
  {
    iconName: "engine.png",
    brandName: "Engine",
  ...
  {
    iconName: "fenderliner.png",
    brandName: "Fender Liner",
  },
  {
    iconName: "frontaxle.png",
    brandName: "Front Axle",
  },
  {
    iconName: "fueltank.png",
    brandName: "Fuel Tank",
  },
  {
    iconName: "hubcap.png",
  ...
  function initiateGame() {
    ...
    for(let i=0; i<randomDraggableBrands.length; i++) {
      draggableItems.insertAdjacentHTML("beforeend", `
        <img src="/assets/carparts/hard/${randomDraggableBrands[i].iconName}" class="draggable" draggable="true" style="color: ${randomDraggableBrands[i].color};" id="${randomDraggableBrands[i].iconName}">
      `);
    }
  ...
  function drop(event) {
    ...
    if(isCorrectMatching) {
      ...
      imgElement.src = "/assets/carparts/hard/" + draggableElementBrand;
