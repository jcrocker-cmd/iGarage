  ...
  function initiateGame() {
    ...
    for(let i=0; i<randomDraggableBrands.length; i++) {
      draggableItems.insertAdjacentHTML("beforeend", `
        <img src="/assets/vehicle/medium/${randomDraggableBrands[i].iconName}" class="draggable" draggable="true" style="color: ${randomDraggableBrands[i].color}; height: 96px; width: 96px;" id="${randomDraggableBrands[i].iconName}">
      `);
    }
